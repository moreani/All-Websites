      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            For inquiries, feedback, or support, feel free to reach out to us. We're here to help transform your customer service experience.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="bg-gray-50 rounded-xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button 
                type="submit"
                className="w-full bg-primary hover:bg-primary/90 text-white py-4 rounded-lg font-semibold transition-colors duration-300"
              >
                Send Message
              </Button>
            </form>
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">info@complaint.co.in</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">complaint.co.in</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-6">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 text-sm mb-3">Get instant help via WhatsApp</p>
                  <Button 
            ...
            <div className="rounded-xl overflow-hidden shadow-lg">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3771.5434567890123!2d72.8899!3d19.0432!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTnCsDAyJzM1LjciTiA3MsKwNTMnMjMuNiJF!5e0!3m2!1sen!2sin!4v1234567890"
                width="100%"
                height="250"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Complaint AI Solutions Office Location"
              ></iframe>
            </div>
          </div>
        </div>
