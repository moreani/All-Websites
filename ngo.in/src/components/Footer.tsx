      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="font-roboto font-bold text-3xl mb-4">
              <span className="text-primary">NGOVision</span>
              <span className="text-accent">.ai</span>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              Empowering nonprofits with intelligent AI solutions to maximize their impact and streamline operations.
            </p>
          ...
          <div>
            <h3 className="font-roboto font-semibold text-lg mb-4">Services</h3>
            <ul className="space-y-2">
              <li><span className="text-gray-300">Data Analytics</span></li>
              <li><span className="text-gray-300">Outreach Tools</span></li>
              <li><span className="text-gray-300">Automation</span></li>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 NGOVision.ai. All rights reserved. | Owned by{' '}
